...
function runTestsV1714(){
  ...
  eq('85 Regelfähigkeiten',85,SKILLS.length);eq('85 eindeutige Fähigkeits-IDs',85,new Set(SKILLS.map(function(skill){return skill.id})).size);eq('85 eindeutige Fähigkeitsnamen',85,new Set(SKILLS.map(function(skill){return skill.name})).size);
