...
function runTestsV1714(){
  ...
  eq('86 Regelfähigkeiten',86,SKILLS.length);eq('86 eindeutige Fähigkeits-IDs',86,new Set(SKILLS.map(function(skill){return skill.id})).size);eq('86 eindeutige Fähigkeitsnamen',86,new Set(SKILLS.map(function(skill){return skill.name})).size);
