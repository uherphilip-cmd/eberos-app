...
function runTestsV178R4(){
  ...
  eq('Revision r4: Schema 17',17,SCHEMA_VERSION);eq('Revision r4: Regelversion 7',7,RULES_VERSION);eq('Revision r4: 270 Kräfte unverändert',270,POWER_ENTRIES_V176.length);
